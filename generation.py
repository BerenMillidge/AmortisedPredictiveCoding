# Testing producing generated images with the networks which is really nice and seeing how that works
#basically the thing is, I think we can test both amortised AND variational generation capacity. Should be really fun
