...
def run_amortised(save_name,use_backward_weights,use_backward_nonlinearity,compute_weight_angles):
    batch_size = 10
    num_batches = 10
    num_test_batches = 20
...
if __name__ == "__main__":
    ...
    compute_weight_angles = True
    run_amortised(sname,use_backward_weights,use_backward_nonlinearity,compute_weight_angles)
